...
query_prompt_template = PromptTemplate(
    ...
    "{context_str}\n"
    "---------------------\n"
    "Dựa trên dữ liệu cuộc trò chuyện, hãy viết lại câu hỏi của người dùng dưới dạng một câu hỏi duy nhất có ngữ cảnh sao cho không cần biết cuộc trò chuyện trước đó vẫn đọc hiểu câu hỏi. Lưu ý, câu hỏi sau cùng là 1 câu duy nhất.\n"
    "Viết lại câu hỏi của người dùng bằng tiếng Việt: "
)
...
{context_str}
---------------------
Dựa trên những ngữ liệu tham khảo này, hãy đưa ra chỉ những câu hỏi cho câu truy vấn dưới đây.
Câu hỏi phải được viết dưới dạng câu hỏi hoàn chỉnh và cụ thể nhất có thể. Câu truy vấn:
{query_str}
"""
)
